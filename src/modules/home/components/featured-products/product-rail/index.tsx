    ...
    <div className="small:py-2">
      <div className="content-container py-2">
        <div className="flex justify-between mb-8">
          ...
          <InteractiveLink className="bg-white hover:bg-[#008f39] hover:text-white text-[#008f39] px-[16px] py-[10px] border-1 border-[#008f39] rounded" href={`/collections/${collections.handle}`}>
            Ver Todos
          </InteractiveLink>
        </div>
